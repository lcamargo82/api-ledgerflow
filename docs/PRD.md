...
- Gestão Financeira completa: parcialmente preparada. O modelo de transações existe para suportar saldo inicial, mas endpoints gerais de receitas/despesas e relatórios ainda não foram implementados.
